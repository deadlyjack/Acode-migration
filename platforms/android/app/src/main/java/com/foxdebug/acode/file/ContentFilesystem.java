...
public class ContentFilesystem extends Filesystem {
    ...
    public ContentFilesystem(Context context, ResourceApi resourceApi, Preferences preferences) {
    ...
    public JSONObject getFileMetadataForLocalURL(LocalFilesystemURL inputURL) throws FileNotFoundException {
        ...
        try {
            if (cursor != null && cursor.moveToFirst()) {
                ...
                ResourceApi.OpenForReadResult offr = resourceApi.openForRead(nativeUri);
                size = offr.length;
            }
        } catch (IOException e) {
