...
public class Executor extends Service {
    ...
    private final java.util.Map<String, Callback> callbackContextMap = new java.util.concurrent.ConcurrentHashMap<>();
     ...
     */
    private boolean ensureServiceBound(Callback callbackContext) {
     ...
     */
    private boolean bindServiceNow(Callback callbackContext) {
        if (isServiceBinding) {
    ...
    private class IncomingHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (action.equals("exec_result")) {
                com.foxdebug.acode.runtime.Callback callbackContext = getCallbackContext(id);
                ...
                if (callbackContext != null) {
                    switch (action) {
                        case "stdout":
                        case "stderr":
                            Payload result = new Payload(Payload.Status.OK, action + ":" + data);
    ...
    private void startProcess(String pid, String cmd, String alpine) {
        ...
        try {
            ...
            Callback errorContext = getCallbackContext(pid);
    ...
    private void exec(String execId, String cmd, String alpine) {
        ...
        try {
            ...
            com.foxdebug.acode.runtime.Callback callbackContext = getCallbackContext(execId);
            if (callbackContext != null) {
    ...
    private void listProcesses(String requestId) {
        ...
        try {
            ...
            com.foxdebug.acode.runtime.Callback callbackContext = getCallbackContext(requestId);
            if (callbackContext != null) {
    ...
    private Callback getCallbackContext(String id) {
