...
abstract class NativeHttpBase implements Runnable {
  protected static final String TAG = "Native-Plugin-HTTP";
  ...
  protected NativeObservableCallbackContext callbackContext;

  public NativeHttpBase(String method, String url, String serializer, Object data, JSONObject headers, int connectTimeout,
  ...
  public NativeHttpBase(String method, String url, JSONObject headers, int connectTimeout, int readTimeout, boolean followRedirects,
  ...
  protected void setAborted(HttpRequest request, NativeHttpResponse response) {
