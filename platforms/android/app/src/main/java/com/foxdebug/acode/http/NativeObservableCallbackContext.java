...
public class NativeObservableCallbackContext {

    private Callback callbackContext;
    private Integer requestId;
    private Observer observer;

    public NativeObservableCallbackContext(Callback callbackContext, Integer requestId) {
     ...
     * <pre>observer.update(null, BridgeObservableCallbackContext)</pre>
     * @param observer
     */
