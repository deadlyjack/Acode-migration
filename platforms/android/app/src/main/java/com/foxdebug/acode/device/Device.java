/*
       ...
       under the License.
*/
package com.foxdebug.acode.device;
...
public class Device extends Service {
     ...
     *
     * @param Bridge The context of the main Activity.
     * @param webView The AppView Native is running in.
     */
    ...
    /**
     * Executes the request and returns Payload.
     *
    ...
    public String getUuid() {
        String uuid = Settings.Secure.getString(this.host.getActivity().getContentResolver(), android.provider.Settings.Secure.ANDROID_ID);
        return uuid;
    }
