...
public class WebSocketPlugin extends Service {
    ...
    @Override
    public boolean execute(String action, JSONArray args, final Callback callbackContext) throws JSONException {
            ...
            public void run() {
                ...
                switch (action) {
                    case "connect":
                        ...
                        WebSocketInstance instance = new WebSocketInstance(url, protocols, headers, binaryType, okHttpMainClient, host, id);
