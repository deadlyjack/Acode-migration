...
import com.foxdebug.acode.runtime.Preferences;
...
public abstract class Filesystem {
    ...
    protected final ResourceApi resourceApi;
    ...
    public Filesystem(Uri rootUri, String name, ResourceApi resourceApi, Preferences preferences) {
    ...
    public JSONObject copyFileToURL(LocalFilesystemURL destURL, String newName,
        ...
        ResourceApi.OpenForReadResult ofrr = resourceApi.openForRead(srcNativeUri);
    ...
    public void readFileAtURL(LocalFilesystemURL inputURL, long start, long end,
        ...
        ResourceApi.OpenForReadResult ofrr = resourceApi.openForRead(toNativeUri(inputURL));
        if (end < 0) {
            end = ofrr.length;
        }
