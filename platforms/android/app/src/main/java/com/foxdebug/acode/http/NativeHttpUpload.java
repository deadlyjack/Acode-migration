...
class NativeHttpUpload extends NativeHttpBase {
  private JSONArray filePaths;
  private JSONArray uploadNames;
  private Context applicationContext;

  public NativeHttpUpload(String url, JSONObject headers, JSONArray filePaths, JSONArray uploadNames, int connectTimeout, int readTimeout,
      boolean followRedirects, String responseType, TLSConfiguration tlsConfiguration,
      Context applicationContext, NativeObservableCallbackContext callbackContext) {
