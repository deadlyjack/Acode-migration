package com.foxdebug.acode.ftp;
...
public class Ftp extends Service {
  ...
  public void initialize(BridgeContext bridgeContext) {
    ...
    context = bridgeContext.getWebActivity();
    activity = bridgeContext.getWebActivity();
  }
  ...
  public void connect(JSONArray args, Callback callback) {
  ...
  public void listDirectory(JSONArray args, Callback callback) {
    Acode.getInstance()
      .getThreadPool()
      .execute(
        new Runnable() {
  ...
  public void exists(JSONArray args, Callback callback) {
    ...
    Acode.getInstance().getThreadPool()
      .execute(
        new Runnable() {
          public void run() {
            String ftpId = args.optString(0);
  ...
  public void sendNoOp(JSONArray args, Callback callback) {
    Acode.getInstance().getThreadPool()
      .execute(
        new Runnable() {
          public void run() {
  ...
  public void deleteFile(JSONArray args, Callback callback) {
    Acode.getInstance().getThreadPool()
      .execute(
        new Runnable() {
          public void run() {
  ...
  public void deleteDirectory(JSONArray args, Callback callback) {
    Acode.getInstance().getThreadPool()
      .execute(
        new Runnable() {
          public void run() {
  ...
  public void downloadFile(JSONArray args, Callback callback) {
    Acode.getInstance().getThreadPool()
      .execute(
        new Runnable() {
          public void run() {
  ...
  public void uploadFile(JSONArray args, Callback callback) {
    Acode.getInstance().getThreadPool()
      .execute(
        new Runnable() {
          public void run() {
  ...
  public void getKeepAlive(JSONArray args, Callback callback) {
    Acode.getInstance().getThreadPool()
      .execute(
        new Runnable() {
          public void run() {
  ...
  public void execCommand(JSONArray args, Callback callback) {
    Acode.getInstance().getThreadPool()
      .execute(
        new Runnable() {
          public void run() {
  ...
  public void disconnect(JSONArray args, Callback callback) {
    Acode.getInstance().getThreadPool()
      .execute(
        new Runnable() {
          public void run() {
  ...
  public void changeDirectory(JSONArray args, Callback callback) {
    Acode.getInstance().getThreadPool()
      .execute(
        new Runnable() {
          public void run() {
  ...
  public void getWorkingDirectory(JSONArray args, Callback callback) {
    Acode.getInstance().getThreadPool()
      .execute(
        new Runnable() {
          public void run() {
  ...
  public void getStat(JSONArray args, Callback callback) {
    Acode.getInstance().getThreadPool()
      .execute(
        new Runnable() {
          public void run() {
